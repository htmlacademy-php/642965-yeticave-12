...
<head>
    <meta charset="UTF-8">
    <title><?= esc($lot_card[0]['name_lot']) ?></title>
...
<div class="page-wrapper">
    ...
    <main>
        ...
        <section class="lot-item container">
            <?php foreach ($lot_card as $value):
                list ($hours, $minutes) = difference_date($value['dt_complete']);
            ?>
            <h2><?= esc($value['name_lot']) ?></h2>
            <div class="lot-item__content">
                <div class="lot-item__left">
                    <div class="lot-item__image">
                        <img src="<?= esc($value['image']) ?>" width="730" height="548" alt="Сноуборд">
                    </div>
                    <p class="lot-item__category">Категория: <span><?= esc($value['name_cat']) ?></span></p>
                    <p class="lot-item__description"><?= esc($value['description']) ?></p>
                </div>
                    ...
                    <div class="lot-item__state">
                        ...
                        <div class="lot-item__cost-state">
                            <div class="lot-item__rate">
                                ...
                                <span class="lot-item__cost"><?= esc(price_format($value['price_start'])) ?></span>
                            </div>
