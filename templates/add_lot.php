    ...
    <form class="form form--add-lot container <?php if (count($errors)): ?>form--invalid<?php endif ?>" action="add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
        ...
        <div class="form__container-two">
            ...
            <div class="form__item <?= $classname ?>">
                ...
                <select id="category_id" name="category">
                    ...
                    <?php foreach ($categories as $value): ?>
                    <option value="<?= $value['id'] ?>"<?php if ($value['id'] == getPostVal('category')): ?> selected <?php endif; ?>><?= esc($value['name_cat']) ?></option>
                    <?php endforeach ?>
                </select>
        ...
        <div class="form__container-three">
            ...
            <div class="form__item <?= $classname ?>">
                ...
                <input class="form__input-date" id="lot-date1" type="text" name="lot-date" placeholder="Введите дату в формате ГГГГ-ММ-ДД" value="<?= getPostVal('lot-date') ?>" >
