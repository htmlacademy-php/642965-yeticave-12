    ...
    <section class="rates container">
        ...
        <table class="rates__list">
            <?php foreach ($myBets as $myBet): ?>
                <tr class="rates__item <?= ratesItemClass($myBet['dt_complete'], $userId, $myBet['user_winner_id']) ?>">
                    <td class="rates__info">
                        <div class="rates__img">
                            <img src="<?= esc($myBet['image']) ?>" width="54" height="40"
                                 alt="<?= esc($myBet['lot_name']) ?>">
                        </div>
                        <div>
                    ...
                    <td class="rates__timer">
                        <div class="timer <?= timerClass($myBet['dt_complete'], $userId, $myBet['user_winner_id']) ?>">
                            <?= esc(timerResult($myBet['dt_complete'], $userId, $myBet['user_winner_id'])) ?>
                        </div>
                    </td>
